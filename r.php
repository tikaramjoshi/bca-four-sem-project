    ...
    <div class="register-page">
        <div class="from-register">
            ...
            <form method="POST">
                ...
                <div class="lab-inp pass"> <input type="password" name="password" id="pas" required> <label>Password</label> <span class="pass_view" onclick="passView('pas', this)"><i class="fa-solid fa-eye"></i></span></div>
                <div class="lab-inp pass"> <input type="password" name="confirm_password" id="c_pas" required> <label>Confirm Password</label> <span class="pass_view" onclick="passView('c_pas', this)" ><i class="fa-solid fa-eye"></i></span> </div>
