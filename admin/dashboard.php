...
$totalPassengerVerification = $conn->query("
    SELECT COUNT(*)
    FROM users
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="setting">
                ...
                <img src="../uploads/profile/admin/<?= htmlspecialchars($admin_name) ?>/<?= htmlspecialchars($profile_image) ?>"
                    alt="Profile"
...
>>>>>>> b1d3c0b (Create reusable admin header and sidebar include)
        ...
        <div class="content">
            ...
            <div class="table-box notification-box">
                ...
                <?php if (
                    $totalPending == 0 &&
                    $totalOwnerVerification == 0 &&
                    $totalDriverVerification == 0 &&
                    $totalPassengerVerification == 0
                ): ?>
                    ...
                    <div class="table-scroll">
                        ...
                        <table>
                            ...
                            $stmt = $conn->prepare("
                                ...
                                FROM bus
                                INNER JOIN users ON bus.owner_id=users.user_id
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="approve"
                                            href="?action=approve&id=<?= (int)$row['bus_id'] ?>"
                                            onclick="return confirm('Approve this bus?')">
                                            Approve
                                        </a>

                                        <a class="reject"
                                            href="reject_bus.php?id=<?= (int)$row['bus_id'] ?>"
                                            onclick="return confirm('Do you want to reject this bus?')">
                                            Reject
                                        </a>
                    ...
                    <div class="table-scroll">
                        ...
                        <table>
                            ...
                            $stmt = $conn->prepare("
                                ...
                                INNER JOIN users u ON ov.owner_id=u.user_id
                                WHERE ov.status='pending'
                                ORDER BY ov.verification_id DESC
                            ");
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="../uploads/<?= htmlspecialchars($row['owner_photo']) ?>"
                                            target="_blank">
                                            View Photo
                                        </a>
                                    ...
                                    <td>
                                        ...
                                        <a href="../uploads/<?= htmlspecialchars($row['company_certificate']) ?>"
                                            target="_blank">
                                            View Certificate
                                        </a>
                                    ...
                                    <td>
                                        ...
                                        <!-- CORRECT OWNER VERIFY LINK -->
                                        <a href="verify_owner.php?id=<?= (int)$row['verification_id'] ?>"
                                            class="approve"
                                        ...
                                        <a class="reject"
                                            href="reject_owner.php?id=<?= (int)$row['verification_id'] ?>"
            ...
            $stmt = $conn->prepare("
                ...
                INNER JOIN users u ON dv.driver_id=u.user_id
                                ...
                                <?php foreach ($driverVerificationRows as $row): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="view_driver.php?id=<?= (int)$row['driver_id'] ?>"
                                                class="approve">
                                                View
                                            </a>

                                            <!-- DRIVER VERIFY -->
                                            <a href="verify_driver.php?id=<?= (int)$row['verification_id'] ?>"
                                                class="approve"
                                            ...
                                            <!-- DRIVER REJECT -->
                                            <a href="reject_driver.php?id=<?= (int)$row['verification_id'] ?>"
                                                class="reject"
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="approve"
                                            href="verify_passenger.php?id=<?= (int)$row['user_id'] ?>"
                                            onclick="return confirm('Verify this passenger?')">
                                            Verify
                                        </a>

                                        <a class="reject"
                                            href="reject_passenger.php?id=<?= (int)$row['user_id'] ?>"
