                        ...
                        <table>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="approve" href="?action=approve&id=<?= $row['bus_id'] ?>" onclick="return confirm('Approve this bus?')">Approve</a>
                                        <a class="reject" href="reject_bus.php?id=<?= $row['bus_id'] ?>" onclick="return confirm('Do you want to reject this bus?')">Reject</a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        </table>
                        ...
                        <table>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><span class="pending-text">Pending</span></td>
                                    <td>
                                        <a class="approve" href="verify_passenger.php?id=<?= $row['user_id'] ?>">Verify</a>
                                        <a class="reject" href="reject_passenger.php?id=<?= $row['user_id'] ?>">Reject</a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        </table>
