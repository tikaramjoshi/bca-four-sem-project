...
<body>
    ...
    <div class="header">
        ...
        <div class="setting">
            ...
            <img src="../uploads/profile/admin/<?= htmlspecialchars($admin_name) ?>/<?= htmlspecialchars($profile_image) ?>" class="setting-profile" alt="Profile" onclick="toggleMenu()" onerror="this.onerror=null;this.src='../uploads/default.png';">
