    ...
    <div class="box">
        ...
        <table>
            ...
            <tr>
                <td>Facilities</td>
                <td>
                    <?= !empty($bus['facilities'])
                        ? htmlspecialchars($bus['facilities'])
                        : "-"
                    ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php
                    if (!empty($bus['reject_reason'])) {
                        echo nl2br(htmlspecialchars($bus['reject_reason']));
                    } else {
                        echo "-";
                    }
                    ?>
